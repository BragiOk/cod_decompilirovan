...
public class SendWarehouseDepositList : ClientPacket
{
	...
	static SendWarehouseDepositList()
	{
		Il2CppClassPointerStore<SendWarehouseDepositList>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.Networking.ClientPackets.Warehouse", "SendWarehouseDepositList");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SendWarehouseDepositList>.NativeClassPtr);
		NativeFieldInfoPtr__warehouseType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SendWarehouseDepositList>.NativeClassPtr, "_warehouseType");
		NativeFieldInfoPtr__items = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SendWarehouseDepositList>.NativeClassPtr, "_items");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_IReadOnlyList_1_ItemState_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SendWarehouseDepositList>.NativeClassPtr, 100664855);
		NativeMethodInfoPtr_WriteMessage_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SendWarehouseDepositList>.NativeClassPtr, 100664856);
	}

	[CallerCount(0)]
	public unsafe SendWarehouseDepositList(int warehouseType, IReadOnlyList<ItemState> items)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SendWarehouseDepositList>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 17013, XrefRangeEnd = 17031, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public SendWarehouseDepositList(IntPtr pointer)
		: base(pointer)
	{
	}
}
