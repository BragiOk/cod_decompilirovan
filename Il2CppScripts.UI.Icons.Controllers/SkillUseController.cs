...
public class SkillUseController : MonoBehaviour
{
	...
	static SkillUseController()
	{
		Il2CppClassPointerStore<SkillUseController>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.UI.Icons.Controllers", "SkillUseController");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr);
		NativeFieldInfoPtr__allowLeftClick = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr, "_allowLeftClick");
		NativeFieldInfoPtr__allowRightClick = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr, "_allowRightClick");
		NativeFieldInfoPtr__allowDoubleClick = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr, "_allowDoubleClick");
		NativeFieldInfoPtr_Delayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr, "Delayer");
		NativeMethodInfoPtr_HandleIconEvent_Public_Virtual_Final_New_Boolean_IconHandle_IconEvent_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr, 100666906);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr, 100666907);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 35707, XrefRangeEnd = 35711, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe SkillUseController()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SkillUseController>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SkillUseController(IntPtr pointer)
		: base(pointer)
	{
	}
}
