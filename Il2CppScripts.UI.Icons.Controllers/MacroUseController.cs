...
public class MacroUseController : MonoBehaviour
{
	...
	static MacroUseController()
	{
		Il2CppClassPointerStore<MacroUseController>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.UI.Icons.Controllers", "MacroUseController");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr);
		NativeFieldInfoPtr__allowLeftClick = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr, "_allowLeftClick");
		NativeFieldInfoPtr__allowRightClick = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr, "_allowRightClick");
		NativeFieldInfoPtr__allowDoubleClick = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr, "_allowDoubleClick");
		NativeFieldInfoPtr_Delayer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr, "Delayer");
		NativeMethodInfoPtr_HandleIconEvent_Public_Virtual_Final_New_Boolean_IconHandle_IconEvent_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr, 100666903);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr, 100666904);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 35704, XrefRangeEnd = 35707, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe MacroUseController()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MacroUseController>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public MacroUseController(IntPtr pointer)
		: base(pointer)
	{
	}
}
