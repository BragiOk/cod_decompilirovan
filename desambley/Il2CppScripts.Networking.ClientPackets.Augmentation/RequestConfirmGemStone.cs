...
public class RequestConfirmGemStone : ClientPacket
{
	...
	static RequestConfirmGemStone()
	{
		Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.Networking.ClientPackets.Augmentation", "RequestConfirmGemStone");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr);
		NativeFieldInfoPtr__targetItemObjectId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr, "_targetItemObjectId");
		NativeFieldInfoPtr__refinerItemObjectId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr, "_refinerItemObjectId");
		NativeFieldInfoPtr__gemstoneItemObjectId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr, "_gemstoneItemObjectId");
		NativeFieldInfoPtr__gemstoneCount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr, "_gemstoneCount");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr, 100665049);
		NativeMethodInfoPtr_WriteMessage_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr, 100665050);
	}

	[CallerCount(0)]
	public unsafe RequestConfirmGemStone(int targetItemObjectId, int refinerItemObjectId, int gemstoneItemObjectId, int gemstoneCount)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RequestConfirmGemStone>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 17661, XrefRangeEnd = 17668, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public RequestConfirmGemStone(IntPtr pointer)
		: base(pointer)
	{
	}
}
