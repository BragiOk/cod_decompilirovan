...
public class RequestAquireSkill : ClientPacket
{
	...
	static RequestAquireSkill()
	{
		Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.Networking.ClientPackets.SkillLearn", "RequestAquireSkill");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr);
		NativeFieldInfoPtr__id = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr, "_id");
		NativeFieldInfoPtr__level = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr, "_level");
		NativeFieldInfoPtr__skillType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr, "_skillType");
		NativeMethodInfoPtr__ctor_Public_Void_Int32_Int32_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr, 100664895);
		NativeMethodInfoPtr_WriteMessage_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr, 100664896);
	}

	[CallerCount(0)]
	public unsafe RequestAquireSkill(int id, int level, int skillType)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RequestAquireSkill>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 17217, XrefRangeEnd = 17222, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public RequestAquireSkill(IntPtr pointer)
		: base(pointer)
	{
	}
}
