...
public class UnitySourceGeneratedAssemblyMonoScriptTypes_v1 : Il2CppSystem.Object
{
	...
	{
		Il2CppClassPointerStore<UnitySourceGeneratedAssemblyMonoScriptTypes_v1>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "", "UnitySourceGeneratedAssemblyMonoScriptTypes_v1");
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 0, XrefRangeEnd = 11, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(17)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 28, XrefRangeStart = 11, XrefRangeEnd = 11, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
