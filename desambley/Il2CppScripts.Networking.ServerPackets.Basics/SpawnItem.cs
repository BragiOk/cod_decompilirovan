...
public class SpawnItem : ServerPacket
{
	...
	static SpawnItem()
	{
		Il2CppClassPointerStore<SpawnItem>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.Networking.ServerPackets.Basics", "SpawnItem");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr);
		NativeFieldInfoPtr__objectId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, "_objectId");
		NativeFieldInfoPtr__itemId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, "_itemId");
		NativeFieldInfoPtr__position = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, "_position");
		NativeFieldInfoPtr__stackable = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, "_stackable");
		NativeFieldInfoPtr__count = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, "_count");
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, 100664797);
		NativeMethodInfoPtr_ReadMessage_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, 100664798);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr, 100664799);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 16605, XrefRangeEnd = 16611, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 16611, XrefRangeEnd = 16619, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe SpawnItem()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SpawnItem>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
	...
	public SpawnItem(IntPtr pointer)
		: base(pointer)
	{
	}
}
