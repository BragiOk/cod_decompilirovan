...
public class GetItem : ServerPacket
{
	...
	static GetItem()
	{
		Il2CppClassPointerStore<GetItem>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.Networking.ServerPackets.Basics", "GetItem");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<GetItem>.NativeClassPtr);
		NativeFieldInfoPtr__playerId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GetItem>.NativeClassPtr, "_playerId");
		NativeFieldInfoPtr__objectId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GetItem>.NativeClassPtr, "_objectId");
		NativeFieldInfoPtr__position = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GetItem>.NativeClassPtr, "_position");
		NativeMethodInfoPtr_Apply_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetItem>.NativeClassPtr, 100664727);
		NativeMethodInfoPtr_ReadMessage_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetItem>.NativeClassPtr, 100664728);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GetItem>.NativeClassPtr, 100664729);
	}

	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 15999, XrefRangeEnd = 16015, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe GetItem()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GetItem>.NativeClassPtr))
	{
		IntPtr* ptr = null;
		Unsafe.SkipInit(out IntPtr intPtr2);
