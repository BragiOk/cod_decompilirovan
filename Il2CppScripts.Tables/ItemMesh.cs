...
public class ItemMesh : Il2CppSystem.Object
{
	...
	public unsafe Il2CppStringArray Meshes
	{
		get
		{
	...
	static ItemMesh()
	{
		Il2CppClassPointerStore<ItemMesh>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.Tables", "ItemMesh");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ItemMesh>.NativeClassPtr);
		NativeFieldInfoPtr_Meshes = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ItemMesh>.NativeClassPtr, "Meshes");
		NativeFieldInfoPtr_Materials = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ItemMesh>.NativeClassPtr, "Materials");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ItemMesh>.NativeClassPtr, 100663705);
	}

	[CallerCount(17)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 28, XrefRangeStart = 11, XrefRangeEnd = 28, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ItemMesh()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ItemMesh>.NativeClassPtr))
	{
	...
	public ItemMesh(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
