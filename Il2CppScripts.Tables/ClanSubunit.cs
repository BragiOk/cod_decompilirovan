...
public class ClanSubunit : DataEntry
{
	...
	static ClanSubunit()
	{
		Il2CppClassPointerStore<ClanSubunit>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-Scripts.dll", "Scripts.Tables", "ClanSubunit");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ClanSubunit>.NativeClassPtr);
		NativeFieldInfoPtr_name_ru = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ClanSubunit>.NativeClassPtr, "name_ru");
		NativeFieldInfoPtr_name_en = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ClanSubunit>.NativeClassPtr, "name_en");
		NativeFieldInfoPtr_icon = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ClanSubunit>.NativeClassPtr, "icon");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ClanSubunit>.NativeClassPtr, 100663671);
	}

	[CallerCount(17)]
	[CachedScanResults(RefRangeStart = 11, RefRangeEnd = 28, XrefRangeStart = 11, XrefRangeEnd = 28, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ClanSubunit()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ClanSubunit>.NativeClassPtr))
	{
		IntPtr* ptr = null;
	...
	public ClanSubunit(IntPtr pointer)
		: base(pointer)
	{
	}
}
